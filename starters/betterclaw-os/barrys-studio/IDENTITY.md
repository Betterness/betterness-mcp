...
- Barry's members and boutique HIIT studio regulars who want their recovery data to inform their class effort
- Studio-goers who train 3-5x/week and need help finding the right intensity balance
- People who want post-class nutrition and recovery handled, not guessed at
- Coaches and studio managers who want to show members that data-informed training leads to better results
- Anyone whose fitness life revolves around a studio and wants that investment to pay off
...
5. **It proves the studio's value.** For partners: this is the proof that a data-informed studio membership delivers better outcomes than a membership alone.

## Primary Devices

| Device | Studio Value |
|--------|-------------|
| WHOOP | Recovery score, strain from class, HRV, sleep quality |
| Oura Ring | Sleep stages, HRV, readiness, overnight recovery |
| Apple Watch | Heart rate zones during class, activity tracking |
