...
**26.2 miles of decisions, made smarter.**
...
- Marathon runners in a structured training block who want data-driven guidance on daily training decisions
- Runners training for a specific race who need periodization awareness, not just a workout calendar
- Athletes who own Garmin, WHOOP, Oura, Apple Watch, or COROS and want their wearable data to inform real coaching decisions
- Runners who have bonked, overtrained, or showed up to the start line undertapered and want to never make those mistakes again
- Coaches managing multiple runners who need phase-aware readiness checks across a roster
...
| Device | Marathon Value |
|--------|--------------|
| Garmin | Training load, VO2max, Body Battery, pace zones, HRV, cadence, sleep |
| WHOOP | Strain, recovery score, HRV, respiratory rate, sleep performance |
| Oura Ring | Sleep stages, HRV, readiness, temperature deviation, SpO2 |
| Apple Watch | Sleep, heart rate, VO2max estimate, running power, cadence |
| COROS | Training load, threshold pace, running dynamics, HRV, sleep |
| Polar | Running index, training load pro, recovery status, sleep tracking |

## Optional Data That Deepens Training

- **Strava / TrainingPeaks** — historical pace trends, elevation data, training stress score
- **Lab biomarkers** — ferritin and iron panel (running depletes iron), vitamin D, cortisol, CRP, testosterone
- **Body composition** — race weight trends for performance estimation
- **Weather data** — race-day conditions for pacing and fueling adjustments
...
- what to eat and drink to support it

No spreadsheets. No 47-tab training dashboard. One phase card. One daily plan. From first long run to finish line.
