...
description: Trimester-specific biomarker monitoring and wellness support during pregnancy
version: 1.0.0
author: betterness
category: womens-health
requires:
  tools: [searchBiomarkers, getSleepData, getSleepStages, getVitals, getActivityData, getBodyComposition]
  data: prenatal blood panel + wearable
skillgraph:
  domains: [pregnancy, hormones, iron, thyroid, glucose, sleep, activity]
  device_affinities: [oura, apple-health, withings, garmin]
  activity_affinities: [walking, prenatal-yoga, any-low-impact]
  biomarker_affinities: [ferritin, hemoglobin, folate, b12, tsh, free-t4, fasting-glucose, hba1c, vitamin-d, calcium]
  goals: [pregnancy-health, baby-health, anemia-prevention, gestational-diabetes-prevention]
  actions_enabled: [upload-lab-result, purchase-lab-test, connect-device]
  connection_upsell: [upload-prenatal-panel, purchase-pregnancy-monitoring-panel, connect-oura-for-sleep]
  complements: [female-hormone-balance, thyroid-deep-dive, iron-deficiency-detective, vitamin-d-tracker]
  persona_compatible: [pregnant-user, womens-health-focused]
  evidence_bundles: []
  listings_hooks: []
  venue_affinities: [prenatal-wellness-centers, ob-gyn-practices]
  icp_affinities: [pregnant, womens-health, any-female]
  user_segments: [pregnant-user, lab-result-uploader]
---
