...
description: Track HRV rebound and recovery trajectory after intense training sessions
version: 1.0.0
author: betterness
category: fitness-performance
requires:
  tools: [getVitals, getSleepData, getSleepStages, getActivityData, searchBiomarkers, getBodyComposition]
  data: wearable with HRV + sleep staging, recent workout data
skillgraph:
  domains: [recovery, hrv, sleep, training-load, muscle-recovery]
  device_affinities: [oura, whoop, garmin, apple-health]
  activity_affinities: [strength, hiit, endurance, crossfit]
  biomarker_affinities: [creatine-kinase, cortisol, testosterone, crp]
  goals: [recovery, performance, injury-prevention]
  ...
  complements: [recovery-coach, athlete-overtraining-detector, sleep-analyst, cardio-load-readiness-gate]
  persona_compatible: [strength-athlete, endurance-performance-coach, crossfit-athlete, biohacker]
  evidence_bundles: []
  listings_hooks: []
  venue_affinities: [gyms, crossfit-boxes, endurance-clubs]
  icp_affinities: [athlete, biohacker, fitness-enthusiast]
  user_segments: [any-wearable-user, active-athlete]
---
