---
name: athlete-overtraining-detector
description: Detect overtraining syndrome using HRV, sleep, biomarkers, and training load
version: 1.0.0
author: betterness
category: fitness-performance
requires:
  tools: [getVitals, getSleepData, getSleepStages, getActivityData, searchBiomarkers, getBodyComposition]
  data: 30+ days wearable data, optional blood panel
skillgraph:
  domains: [overtraining, hrv, training-load, recovery, hormones]
  device_affinities: [oura, whoop, garmin, apple-health]
  activity_affinities: [endurance, crossfit, strength, hiit, running, triathlon]
  biomarker_affinities: [cortisol, testosterone, crp, creatine-kinase, ferritin, free-t3]
  goals: [injury-prevention, recovery, performance, health]
  actions_enabled: [connect-device, upload-lab-result, purchase-lab-test]
  connection_upsell: [connect-oura-for-hrv, connect-whoop-for-strain, connect-garmin-for-training-load]
  complements: [recovery-coach, cardio-load-readiness-gate, intensity-distribution-coach, iron-deficiency-detective]
  persona_compatible: [endurance-performance-coach, crossfit-athlete, triathlete, runner]
  evidence_bundles: []
  listings_hooks: []
  venue_affinities: [running-clubs, crossfit-boxes, triathlon-clubs]
  icp_affinities: [athlete, endurance-athlete, biohacker]
  user_segments: [any-wearable-user, active-athlete, high-volume-trainer]
---
