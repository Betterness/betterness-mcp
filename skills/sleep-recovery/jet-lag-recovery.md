...
description: Jet lag recovery protocol using sleep stage and HRV adaptation tracking
version: 1.0.0
author: betterness
category: sleep-recovery
requires:
  tools: [getSleepData, getSleepStages, getVitals, getActivityData, searchBiomarkers]
  data: wearable sleep and vitals before and during travel
skillgraph:
  domains: [sleep, circadian, travel, recovery, hrv]
  device_affinities: [oura, garmin, whoop, apple-health]
  activity_affinities: [any]
  biomarker_affinities: [cortisol, melatonin]
  goals: [recovery, circadian-reset, sleep-quality]
  ...
  complements: [travel-health, sleep-analyst, stress-resilience]
  persona_compatible: [frequent-traveler, executive-optimizer, endurance-performance-coach]
  evidence_bundles: []
  listings_hooks: []
  venue_affinities: [airports, hotels, international-travel]
  icp_affinities: [executive, athlete, frequent-traveler, biohacker]
