...
skillgraph:
  domains: [sleep, recovery, hrv, circadian]
  device_affinities: [oura, whoop, garmin, apple-health, eight-sleep]
  activity_affinities: [any]
  biomarker_affinities: []
  goals: [sleep-quality, recovery, performance]
  actions_enabled: [connect-device]
  connection_upsell: [connect-oura-for-sleep-staging, connect-whoop-for-hrv, connect-garmin-for-sleep-tracking]
  complements: [recovery-coach, sleep-environment-tuner, stress-resilience, morning-briefing]
  persona_compatible: [attia-inspired-longevity-strategist, endurance-performance-coach, biohacker]
  evidence_bundles: []
  listings_hooks: []
  venue_affinities: []
  icp_affinities: [biohacker, athlete, longevity-optimizer]
  user_segments: [oura-user, whoop-user, garmin-user, any-sleep-tracker]
---
