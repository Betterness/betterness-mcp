...
skillgraph:
  domains: [recovery, hrv, sleep, training-readiness]
  device_affinities: [oura, whoop, garmin, apple-health]
  activity_affinities: [strength, cardio, hiit, endurance]
  biomarker_affinities: []
  goals: [recovery, performance, injury-prevention]
  actions_enabled: [connect-device]
  connection_upsell: [connect-oura-for-hrv, connect-whoop-for-recovery-score, connect-garmin-for-training-load]
  complements: [sleep-analyst, cardio-load-readiness-gate, athlete-overtraining-detector, stress-resilience]
  persona_compatible: [endurance-performance-coach, strength-athlete, biohacker]
  evidence_bundles: []
  listings_hooks: []
  venue_affinities: [gym, crossfit, endurance-events]
