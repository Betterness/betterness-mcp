...
description: Analyze gut-related biomarkers, inflammation, and lifestyle for digestive health
version: 1.0.0
author: betterness
category: nutrition-food
requires:
  tools: [searchBiomarkers, getActivityData, getSleepData, getVitals, getBodyComposition, getLoincCodes]
  data: inflammatory + absorption biomarkers + wearable
skillgraph:
  domains: [gut-health, inflammation, nutrition, sleep, microbiome, absorption]
  device_affinities: [oura, garmin, apple-health]
  activity_affinities: [any]
  biomarker_affinities: [hs-crp, esr, b12, folate, vitamin-d, ferritin, albumin, homocysteine]
  goals: [gut-health, reduce-inflammation, nutrition-optimization, energy]
  actions_enabled: [upload-lab-result, purchase-lab-test, connect-device]
  connection_upsell: [upload-inflammatory-panel, purchase-gut-health-panel, connect-oura-for-hrv]
  complements: [inflammation-tracker, supplement-advisor, vitamin-d-tracker, immune-system-check, sleep-analyst]
  persona_compatible: [wellness-focused, biohacker, longevity-optimizer, any]
  evidence_bundles: []
  listings_hooks: []
  venue_affinities: []
