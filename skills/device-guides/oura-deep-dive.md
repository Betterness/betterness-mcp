...
skillgraph:
  domains: [sleep, recovery, hrv, temperature, readiness, oura]
  device_affinities: [oura]
  activity_affinities: [any]
  biomarker_affinities: []
  goals: [sleep-quality, recovery, readiness, hrv-optimization]
  actions_enabled: [connect-device]
  connection_upsell: [connect-oura-ring]
  complements: [sleep-analyst, recovery-coach, thermal-recovery-orchestrator, morning-briefing, weekly-health-report]
  persona_compatible: [biohacker, endurance-performance-coach, longevity-optimizer, any-oura-user]
  evidence_bundles: []
  listings_hooks: [oura-ring]
  venue_affinities: []
  icp_affinities: [biohacker, longevity-optimizer, athlete, oura-user]
  user_segments: [oura-user]
---
