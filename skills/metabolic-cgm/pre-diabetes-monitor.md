---
name: pre-diabetes-monitor
description: Detect insulin resistance and pre-diabetes years before standard diagnosis
version: 1.0.0
author: betterness
category: metabolic-cgm
requires:
  tools: [searchBiomarkers, getActivityData, getSleepData, getBodyComposition, getVitals, getBiologicalAge]
  data: metabolic blood panel + activity/sleep wearable
skillgraph:
  domains: [glucose, insulin-resistance, metabolic, sleep, body-composition]
  device_affinities: [withings, garmin, oura, apple-health, levels-cgm]
  activity_affinities: [walking, any]
  biomarker_affinities: [fasting-glucose, hba1c, fasting-insulin, homa-ir, triglycerides, hdl]
  goals: [diabetes-prevention, metabolic-health, weight-management, longevity]
  ...
  complements: [blood-sugar-optimizer, metabolic-health, metabolic-stress-detector, liver-health-check, pre-diabetes-monitor]
  persona_compatible: [metabolic-optimizer, longevity-optimizer, biohacker, any]
  evidence_bundles: []
  listings_hooks: []
  venue_affinities: []
  icp_affinities: [any, longevity-optimizer, biohacker, metabolic-health-focused]
