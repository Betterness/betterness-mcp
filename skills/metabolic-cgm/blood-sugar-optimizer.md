...
description: Optimize glycemic responses using CGM, activity, sleep, and metabolic biomarkers
version: 1.0.0
author: betterness
category: metabolic-cgm
requires:
  tools: [searchBiomarkers, getActivityData, getSleepData, getVitals, getBodyComposition, getBiologicalAge]
  data: CGM data or fasting glucose + activity/sleep wearable
skillgraph:
  domains: [glucose, metabolic, cgm, sleep, activity, insulin-resistance]
  device_affinities: [levels-cgm, dexcom, libre, oura, garmin, apple-health, withings]
  activity_affinities: [walking, cardio, any]
  biomarker_affinities: [fasting-glucose, hba1c, fasting-insulin, homa-ir, triglycerides, hdl]
  goals: [metabolic-health, blood-sugar-control, weight-management, energy]
  actions_enabled: [upload-lab-result, purchase-lab-test, connect-device]
  connection_upsell: [upload-metabolic-panel, purchase-cgm-compatible-panel, connect-levels-cgm]
  complements: [pre-diabetes-monitor, metabolic-health, metabolic-stress-detector, liver-health-check]
  persona_compatible: [metabolic-optimizer, biohacker, longevity-optimizer, any]
  evidence_bundles: []
  listings_hooks: [levels-cgm, dexcom, libre, nutrisense]
  venue_affinities: []
  icp_affinities: [biohacker, longevity-optimizer, metabolic-health-focused, any]
  user_segments: [cgm-user, lab-result-uploader, any-wearable-user]
---
