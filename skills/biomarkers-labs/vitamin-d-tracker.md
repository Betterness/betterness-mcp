---
name: vitamin-d-tracker
description: Monitor vitamin D levels and correlate with sleep, immunity, and bone health
version: 1.0.0
author: betterness
category: biomarkers-labs
requires:
  tools: [searchBiomarkers, getSleepData, getSleepStages, getVitals, getActivityData]
  data: vitamin D bloodwork + wearable sleep data
skillgraph:
  domains: [vitamin-d, sleep, immunity, bone-health, seasonal]
  device_affinities: [oura, garmin, apple-health, any]
  activity_affinities: [outdoor, any]
  biomarker_affinities: [vitamin-d, calcium, pth, magnesium, phosphorus, wbc, lymphocytes]
  goals: [immune-health, sleep-quality, bone-health, vitamin-d-optimization]
  actions_enabled: [upload-lab-result, purchase-lab-test, connect-device]
  connection_upsell: [upload-vitamin-d-result, purchase-vitamin-d-panel, connect-oura-for-sleep-stages]
  complements: [immune-system-check, sleep-analyst, inflammation-tracker, supplement-advisor]
  persona_compatible: [any, longevity-optimizer, biohacker]
  evidence_bundles: []
  listings_hooks: []
  venue_affinities: []
