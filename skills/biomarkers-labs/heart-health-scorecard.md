---
name: heart-health-scorecard
description: Comprehensive cardiovascular health score across lipids, inflammation, fitness, metabolic, and recovery domains
version: 1.0.0
author: betterness
category: biomarkers-labs
requires:
  tools: [searchBiomarkers, getVitals, getActivityData, getBodyComposition, getSleepData, getBiologicalAge]
  data: lipid panel + inflammatory markers + wearable data
skillgraph:
  domains: [cardiovascular, lipids, inflammation, metabolic, fitness, sleep]
  device_affinities: [garmin, oura, whoop, withings, apple-health]
  activity_affinities: [cardio, any]
  biomarker_affinities: [apob, lpa, hs-crp, homocysteine, fasting-glucose, fasting-insulin, hba1c, ldl, hdl, triglycerides]
  goals: [cardiovascular-health, longevity, prevention]
  actions_enabled: [upload-lab-result, purchase-lab-test, connect-device]
  connection_upsell: [upload-advanced-lipid-panel, purchase-apob-lpa-panel, connect-garmin-for-vo2max]
  complements: [cardio-assessment, inflammation-tracker, metabolic-health, longevity-protocol, bio-age-reducer]
