...
skillgraph:
  domains: [inflammation, metabolic, sleep, body-composition, recovery]
  device_affinities: [oura, garmin, withings, apple-health]
  activity_affinities: [any]
  biomarker_affinities: [hs-crp, esr, homocysteine, ferritin, wbc, alp, ggt]
  goals: [reduce-inflammation, longevity, cardiovascular-health, recovery]
  actions_enabled: [upload-lab-result, purchase-lab-test, connect-device]
  connection_upsell: [upload-inflammatory-panel, purchase-hs-crp-panel, connect-oura-for-hrv]
  complements: [heart-health-scorecard, metabolic-health, sleep-analyst, gut-health-optimizer, liver-health-check]
  persona_compatible: [attia-inspired-longevity-strategist, biohacker, any]
  evidence_bundles: []
  listings_hooks: []
  venue_affinities: []
