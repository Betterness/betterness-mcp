...
skillgraph:
  domains: [biomarkers, lab-interpretation, biological-age, health-literacy]
  device_affinities: []
  activity_affinities: []
  biomarker_affinities: [any]
  goals: [awareness, health-literacy, optimization, prevention]
  actions_enabled: [upload-lab-result, purchase-lab-test]
  connection_upsell: [upload-labs-for-interpretation, purchase-comprehensive-panel]
  complements: [inflammation-tracker, metabolic-health, heart-health-scorecard, biological-age-lever-ranker]
  persona_compatible: [attia-inspired-longevity-strategist, biohacker, casual, any]
  evidence_bundles: []
  listings_hooks: []
  venue_affinities: []
  icp_affinities: [any]
