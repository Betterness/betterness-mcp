---
name: kidney-function-monitor
description: Track creatinine, eGFR, and electrolytes to monitor kidney health over time
version: 1.0.0
author: betterness
category: biomarkers-labs
requires:
  tools: [searchBiomarkers, getVitals, getActivityData, getBodyComposition, getSleepData, getLoincCodes]
  data: comprehensive metabolic panel results
skillgraph:
  domains: [kidney, renal, electrolytes, blood-pressure, body-composition]
  device_affinities: [withings, garmin, oura, apple-health]
  activity_affinities: [any]
  biomarker_affinities: [creatinine, bun, egfr, cystatin-c, uric-acid, albumin, potassium, sodium, phosphorus]
  goals: [kidney-health, prevention, longevity]
  actions_enabled: [upload-lab-result, purchase-lab-test, connect-device]
  connection_upsell: [upload-metabolic-panel, purchase-kidney-function-panel, connect-withings-for-blood-pressure]
  complements: [biomarker-decoder, heart-health-scorecard, metabolic-health]
  persona_compatible: [attia-inspired-longevity-strategist, biohacker, athlete, any]
  evidence_bundles: []
  listings_hooks: []
  venue_affinities: []
  icp_affinities: [any, longevity-optimizer, biohacker, athlete]
  user_segments: [lab-result-uploader, creatine-user, athlete]
---
