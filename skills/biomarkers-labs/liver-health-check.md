...
description: Liver enzyme analysis and NAFLD risk assessment with lifestyle correlation
version: 1.0.0
author: betterness
category: biomarkers-labs
requires:
  tools: [searchBiomarkers, getBodyComposition, getActivityData, getSleepData, getVitals, getBiologicalAge]
  data: liver panel bloodwork + body composition
skillgraph:
  domains: [liver, metabolic, body-composition, sleep, activity]
  device_affinities: [withings, garmin, oura, apple-health]
  activity_affinities: [any]
  biomarker_affinities: [alt, ast, ggt, alp, bilirubin, albumin, ferritin, triglycerides, hdl, fasting-glucose]
  goals: [liver-health, metabolic-health, prevention]
  actions_enabled: [upload-lab-result, purchase-lab-test, connect-device]
  connection_upsell: [upload-liver-panel, purchase-metabolic-panel, connect-withings-for-body-comp]
  complements: [metabolic-health, inflammation-tracker, pre-diabetes-monitor, biomarker-decoder]
  persona_compatible: [attia-inspired-longevity-strategist, biohacker, casual]
  evidence_bundles: []
  listings_hooks: []
  venue_affinities: []
  icp_affinities: [any, longevity-optimizer, biohacker]
