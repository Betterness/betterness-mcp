...
description: Evaluate immune readiness from white blood cell counts, nutrients, sleep, and exercise
version: 1.0.0
author: betterness
category: biomarkers-labs
requires:
  tools: [searchBiomarkers, getSleepData, getSleepStages, getVitals, getActivityData, getBodyComposition]
  data: CBC + vitamin D + iron + wearable data
skillgraph:
  domains: [immune, sleep, activity, nutrition, inflammation]
  device_affinities: [oura, garmin, apple-health, any]
  activity_affinities: [any]
  biomarker_affinities: [wbc, lymphocytes, neutrophils, monocytes, hs-crp, esr, vitamin-d, zinc, ferritin, immunoglobulins]
  goals: [immune-health, prevention, energy, travel-readiness]
  actions_enabled: [upload-lab-result, purchase-lab-test, connect-device]
  connection_upsell: [upload-cbc-with-differential, purchase-immune-panel, connect-oura-for-sleep]
  complements: [vitamin-d-tracker, inflammation-tracker, iron-deficiency-detective, sleep-analyst]
  persona_compatible: [any, casual, longevity-optimizer, biohacker]
  evidence_bundles: []
  listings_hooks: []
  venue_affinities: []
  icp_affinities: [any, casual, longevity-optimizer, biohacker]
  user_segments: [lab-result-uploader, frequent-traveler, any]
---
