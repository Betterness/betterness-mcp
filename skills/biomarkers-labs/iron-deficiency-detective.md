---
name: iron-deficiency-detective
description: Detect early-stage iron deficiency before it becomes anemia
version: 1.0.0
author: betterness
category: biomarkers-labs
requires:
  tools: [searchBiomarkers, getActivityData, getVitals, getSleepData, getLoincCodes, listAvailableLabTests]
  data: iron panel bloodwork + wearable data
skillgraph:
  domains: [iron, anemia, endurance, sleep, vitals]
  device_affinities: [oura, garmin, whoop, apple-health]
  activity_affinities: [endurance, running, cycling, any]
  biomarker_affinities: [ferritin, serum-iron, tibc, transferrin-saturation, hemoglobin, hematocrit, mcv, rdw]
  goals: [energy, performance, iron-optimization, prevention]
  actions_enabled: [upload-lab-result, purchase-lab-test, connect-device]
  connection_upsell: [upload-iron-panel, purchase-full-iron-panel, connect-oura-for-resting-hr]
  complements: [athlete-overtraining-detector, endurance-optimizer, female-hormone-balance, immune-system-check]
  persona_compatible: [endurance-performance-coach, womens-health-focused, athlete, biohacker]
  evidence_bundles: []
  listings_hooks: []
  venue_affinities: []
  icp_affinities: [athlete, endurance-athlete, womens-health, biohacker, any]
  user_segments: [lab-result-uploader, endurance-athlete, any-wearable-user]
---
